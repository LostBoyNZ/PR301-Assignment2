...
class CalcData(object):
    ...
    def line_chart(self):
        ...
        ChartLine.set_output_file_name(ChartLine, output_file_name)
        ChartLine.set_data(ChartLine, data)

        if title:
            ChartLine.create_line_grid(ChartLine)
    ...
    def bar_chart(self, choice):
        ...
        if choice == 'bmi':
            ...
            ChartBar.set_output_file_name(ChartBar, output_file_name)
            ChartBar.set_data(ChartBar, data)
    ...
    def pie_chart(self, choice):
        ...
        if choice == 'gender':
            ...
            ChartPie.set_title(ChartPie, title)
            ChartPie.set_y_label(ChartPie, y_label)
            ChartPie.set_labels(ChartPie, data_labels)
            ChartPie.set_fig_title(ChartPie, fig_title)
            ChartPie.set_output_file_name(ChartPie, output_file_name)
            ChartPie.set_data(ChartPie, data)
        ...
        if title:
            ChartPie.create_pie_chart(ChartPie)
